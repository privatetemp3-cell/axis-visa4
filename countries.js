// Axis Visa — Country list with ISO 2-letter codes
// Loaded as a global before the JSX files.
window.COUNTRIES = [
  ...
  {code:"KM",name:"Comoros"},{code:"CD",name:"Congo (DRC)"},{code:"CG",name:"Congo (Republic)"},
